...
classic_simulator.h is the header file for the ClassicSimulator class.
*/

#ifndef CLASSIC_SIMULATOR_H
#define CLASSIC_SIMULATOR_H

#include "abstract_simulator.h"

//The ClassicSimulator Class extends from the AbstractSimulator Class, and simulates the Game of Life with classic mode rules.
class ClassicSimulator : public AbstractSimulator {

public:
  //Default constructor: ClassicSimulator
  ClassicSimulator();
  /*Overloaded constructor: ClassicSimulator
  Parameters:
  ...
  */
  ClassicSimulator(int width, int height, double population_density, int output_type);
  /*Overloaded constructor: ClassicSimulator
  Parameters:
    width: an int representing the number of columns of the grid
    height: an int representing the number of rows of the grid
    ...
    output_type: an int representing which type of output the user chooses
  */
  ClassicSimulator(int width, int height, string user_flatfile, int output_type);
